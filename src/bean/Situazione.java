...
public class Situazione {
	...
	private String fenomeni ;
	
	
	public Situazione(String localita, LocalDate data, int tMedia, int tMin, int tMax, int puntoRugiada, int umidita,
			int visibilita, int ventoMedia, int ventoMax, int raffica, int pressioneSLM, int pressioneMedia,
			int pioggia, String fenomeni) {
		super();
